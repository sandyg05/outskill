...
class ZerodhaBusinessIntelligenceRAG:
    ...
    def setup_document_knowledge(self, doc_folder="/Users/ishandutta/Documents/code/outskill_agents/docs/business"):
    ...
    def setup_brokerage_data_tool(self):
        ...
        def analyze_brokerage_metrics(query: str) -> str:
            ...
            if "client" in query.lower():
                ...
                client_growth = (df['active_clients'].iloc[-1] / df['active_clients'].iloc[0] - 1) * 100
                ...
                arpc_trend = df['avg_revenue_per_client'].iloc[-1] - df['avg_revenue_per_client'].iloc[0]
                ...
                brokerage_share = (df['brokerage_revenue'] / df['revenue_crores']).mean()
                ...
                mf_growth = (df['mutual_fund_revenue'].iloc[-1] / df['mutual_fund_revenue'].iloc[0] - 1) * 100
    ...
    def validate_and_enhance_response(self, response, original_query):
        ...
        try:
            ...
            return {
                ...
                "follow_ups": ["How does this compare to other discount brokers?", "What are the regulatory implications?", "Impact on client acquisition costs?"],
                "risks": ["SEBI regulatory changes", "Market volatility impact", "Competition from traditional brokers"]
            }
    ...
    def ask_zerodha_question(self, question: str, include_validation: bool = True):
        ...
        brokerage_keywords = ['revenue', 'profit', 'client', 'brokerage', 'mutual fund', 'mf', 'margin', 'arpc', 'quarter', 'q1', 'q2', 'q3', 'q4', 'metrics']
        is_brokerage_query = any(keyword in question.lower() for keyword in brokerage_keywords)
        ...
        if include_validation:
            ...
            print(f"   Confidence Score: {validation.get('confidence_score', 'N/A')}/10")
